  ...
  return (
    <div className="list-group">
      <ul>
        ...
        <li className='mb-2'><Link to="/ClipPath" className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold w-60 py-2 px-4 rounded-full">ClipPath</Link></li>
      </ul>
    </div>
  );
}
